...
public class FtpUtils {
     ...
     *@Description
     *   ftp文件上传方法工具
     * @Param: [host, port, username, password, bashPath, filePath, fileName, inputStream]
     * @Return: java.lang.Boolean
     * @Author: ysj
     * @Date: 2020/7/10 18:43
     */
    public static Boolean uploac(String host, Integer port, String username, String password, String bashPath,
        ...
        try {
            ...
            //6.接收返回的状态码
            replyCode = ftpClient.getReplyCode();//如果车工返回203，失败返回503、
            //7.判断
            ...
            if (!ftpClient.changeWorkingDirectory(bashPath + filePath)) {
                //9.如果该文件不存在 创建文件夹
